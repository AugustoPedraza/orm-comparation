...
//        private static Func<EntityFramework.tempdbEntities1, int, EntityFramework.Post> entityFrameworkCompiled
//            = System.Data.Objects.CompiledQuery.Compile<EntityFramework.tempdbEntities1, int, EntityFramework.Post>((db, id) => db.Posts.First(p => p.Id == id));
